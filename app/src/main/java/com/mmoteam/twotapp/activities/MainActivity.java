...
import com.mmoteam.twotapp.fragments.FragmentProfile;
import com.mmoteam.twotapp.fragments.HomeFragment;
import com.mmoteam.twotapp.fragments.NotificationFragment;
import com.mmoteam.twotapp.fragments.RedeemFragment;
...
import com.mmoteam.twotapp.utils.SlidingTabLayout;
import com.mmoteam.twotapp.adapters.ViewPagerAdapter;
import com.mmoteam.twotapp.views.ScrimInsetsFrameLayout;
...
public class MainActivity extends ActivityBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = this;
        init_v3();
        //de cho no hien trang chu truoc
                ...
                public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                    ...
                    switch (menuItem.getItemId()){
                        ...
                        case R.id.navigation_pay:
                            ...
                            selectFragment =new RedeemFragment();
                            break;
                        case R.id.navigation_history:
                            getSupportActionBar().setTitle(R.string.title_history);
                            selectFragment =new TransactionsFragment();
                            break;
                        case R.id.navigation_notification:
                            getSupportActionBar().setTitle(R.string.title_notifi);
...
//        refreshDisplay();
    ...
    void openBauCua(){
        startActivity(new Intent(context, BauCua.class));
    }
    void openQuayso(){
        startActivity(new Intent(context, QuaySo.class));
    }
    void openAbout(){
    ...
    void openWatchAds(){
        startActivity(new Intent(context,WatchAds.class));
    }

    void openWatchAds2(){
        startActivity(new Intent(context,WatchAds2.class));
    }

    void openWatchAds3(){
        startActivity(new Intent(context,WatchAds3.class));
    }

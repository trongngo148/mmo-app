...
public class SignupActivity extends ActivityBase implements GoogleApiClient.OnConnectionFailedListener{
    ...
    private String username, fullname, password, email, user_name,phone;
...
//        getSupportActionBar().setHomeButtonEnabled(true);
         ...
         signupPhone =(EditText) findViewById(R.id.phone_number);

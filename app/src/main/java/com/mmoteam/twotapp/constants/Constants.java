package com.mmoteam.twotapp.constants;

import com.mmoteam.twotapp.app.App;

import static com.mmoteam.twotapp.Config.SERVER_URL;
...
public interface Constants {
    ...
    public static final String ACCOUNT_WATCHADS = API_DOMAIN + "api/" + API_VERSION + "/account.Watchads" + API_FILE_EXTENSION;
    public static final String API_OFFERTORO = API_DOMAIN + "api/" + API_VERSION + "/api.OfferToro" + API_FILE_EXTENSION;
    public static final String ACCOUNT_NOTIFICATION = API_DOMAIN + "api/" + API_VERSION + "/account.Notification" + API_FILE_EXTENSION;
    public static final String APP_BAUCUA = API_DOMAIN + "api/" + API_VERSION + "/account.updatePoints" + API_FILE_EXTENSION;
    public static final String APP_QUAYSO = API_DOMAIN + "api/" + API_VERSION + "/account.quaySo" + API_FILE_EXTENSION;
    ...
    public static final String LICENSE_COPY = "https://www.facebook.com/2tmmo/";
}
package com.mmoteam.twotapp.app;
...
import com.mmoteam.twotapp.utils.LruBitmapCache;
...
public class App extends MultiDexApplication implements Constants {
    ...
    private String username, fullname, accessToken, email, ip_addr,phone;
    private long id;
    ...
    public Boolean authorize(JSONObject authObj) {
        ...
        try {
            ...
            if (configArray.length() > 0) {
                ...
                appStorage.store("WATCH_REWARD", configObj.getString("WATCH_REWARD"));
